...
class AudioViLDConfig:
    def __init__(self, mark_version="mark2.3.2"):
        ...
        # === 학습 파라미터 ===
        self.batch_size = 16
        self.num_epochs = 80 # 100에서 80으로 조정
